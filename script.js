//horário de Brasília////////////////////////////////////////////////////////////////////////////////////////
    setInterval(function relog() {
        ...
        if (s > 59){
         ...
         // Quando aumenta os +30 segundos ele vai contando de 60 segundos a 89 segundos assim com esse if ele arruma.
            if (s >= 60 && s <= 89){
                s = s - 60
            }

         // Deixa a hora do Fuso-Horario certo sem o código ele fica 24:00:00 com o código ele fica 00:00:00
          ...
          // coloca um zero antes dos números abaixo de dez: ex: 1: 1: 1 depois ex 01:01:01////////////////////
